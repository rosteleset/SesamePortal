...
Видеостена запускает отдельные live embed players DVR, без транскодирования
на Portal. Есть общие запуск/остановка и полноэкранный просмотр. Плееры вне
видимой области и в скрытой вкладке останавливаются; при возобновлении берётся
актуальный токен и заново проверяются права. Водяной знак с логином накладывается
